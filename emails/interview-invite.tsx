        ...
        <Container style={container}>
          ...
          <div style={content}>
            ...
            <Text style={paragraph}>
              We are delighted to invite you to interview for the role of{" "}
              <strong>{jobTitle}</strong> at Aston VIP.
            </Text>
            <Text style={paragraph}>
              Our team will be in touch with you very shortly to arrange a convenient
              date and time. Please ensure your contact details are up to date so we
